...
<Container>
  <Row>
    ...
    <h5 className='footer_link-title'>Contact</h5>
      <ListGroup className='footer_quick-links'>
          ...
          <h6 className='mb-0 d-flex align-items-center gap-2'>
            ...
            <p className='mb-0'>travelworld@abc.com</p>  
          </ListGroupItem>
          ...
          <h6 className='mb-0 d-flex align-items-center gap-2'>
            ...
            <p className='mb-0'>+012 345678 23</p>  
          </ListGroupItem>
    ...
    <Col lg='12' className='text-center pt-5'>
      <marquee behavior="" direction=""><p className='CopyRight'>Copyright {year}, Design and develop by Ahmad Majid. All rights reserved.</p></marquee>
    </Col>
  </Row>
</Container>
 </footer>
